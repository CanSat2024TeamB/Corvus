...
def main():
    try:
        # シリアルポートの設定
        ser = serial.Serial(port='/dev/ttyAMA0', baudrate=9600, bytesize=serial.EIGHTBITS, parity=serial.PARITY_NONE, stopbits=serial.STOPBITS_ONE, timeout=1)  # ボーレートとその他の設定を追加
        if ser.is_open:
